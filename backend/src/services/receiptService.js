 ...
 */
export async function generateReceipt(deliveryId) {
 ...
 */
export async function markReceiptGenerated(deliveryId) {
    await Delivery.update({ receiptGenerated: true }, { where: { id: deliveryId } });
}
export default {
    generateReceipt,
